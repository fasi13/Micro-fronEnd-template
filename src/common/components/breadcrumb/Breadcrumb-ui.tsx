...
import { Breadcrumbs, createStyles, Link, LinkProps, ListItem, makeStyles, Typography } from '@material-ui/core';
...
function Breadcrumbui({pathnames}: any) {
  ...
  const classes = useStyles();
    ...
    return (
        <Breadcrumbs maxItems={3} aria-label="breadcrumb" className={classes.breadlink}>
