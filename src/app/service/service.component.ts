...
export class ServiceComponent implements OnInit  {
  ...
  ngOnInit() {
    ...
    const html = `<e2e-${serviceId}-management-app application-id="${applicationId}" base-href="${baseHref}" user-identity="${this.user.id}" user-authorization="Token ${this.userService.getToken()}"></e2e-${serviceId}-management-app>`;
