        ...
        6: [function (a, b) {
            b.exports = function (b, c) {
                ...
                return g.prototype = new e, g.prototype.alwaysMakePathsAbsolute = function () {
                    ...
                    var i = d(),
                        j = b.isFileProtocol ? b.fileAsync : true;
                    "function" == typeof i.overrideMimeType && i.overrideMimeType("text/css"), c.debug("XHR: Getting '" + a + "'"),
                    i.open("GET", a, j),
                    i.setRequestHeader("Accept", e || "text/x-less, text/css; q=0.9, */*; q=0.5"), i.send(null), b.isFileProtocol && !b.fileAsync ? 0 === i.status || i.status >= 200 && 300 > i.status ? f(i.responseText) : g(i.status, a) : j ? i.onreadystatechange = function () {
